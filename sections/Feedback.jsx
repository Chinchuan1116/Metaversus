...
const Feedback = () => (
  ...
  <motion.div variants={fadeIn('right','tween',0.2,1)} className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative">
    ...
    <div>
      ...
      <p className="mt-[18px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading[16px] text-white">Founder | Metaverses</p>
    </div>
    <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading[39px] text-white">"With the development of today's technology, metaverse is very usefull for today's work, or can be called web 3.0. by using metaverse you can use it as anything."</p>
  </motion.div>
  <motion.div variants={fadeIn('left','tween',0.2,1)} className='relative flex-1 flex justify-center items-center'>
    ...
    <motion.div className="lg:block hodden absolute -left-[10%] top-[3%]" variants={zoomIn(0.4,1)}>
